    ...
    <div style={{ paddingBottom: 32 }}>
      ...
      >
        ...
        <h2
          ...
          style={{ fontSize: 24, fontWeight: 500, color: "#EDE9DF" }}
        >
          Settings
        </h2>
      </div>
      ...
      >
        ...
        >
          Ensanit is not a judge. It is a mirror. The goal is never to label
          you as good or bad — it is to illuminate the gap between who you are
          and who you intend to be, with compassion and curiosity.
        </p>
      </motion.div>
      ...
      >
        ...
        >
          All your daily logs are stored securely. The AI reflection feature
          sends only your day's actions and intention securely to the language
          model — no personal information is included.
        </p>
        ...
        {!confirmReset ? (
          <button
            ...
            style={{
              width: "100%",
              color: "#C85E5E",
              borderColor: "rgba(200,94,94,0.3)",
            }}
          >
      ...
      >
        ...
        >
          A self-awareness platform · AI conscience assistant · Digital morality
          journal. Built on one question: How humanely are you living?
        </p>
      </motion.div>
    </div>
  );
